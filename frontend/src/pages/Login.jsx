...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            setError(err.errors ? err.errors[0].longMessage : 'Login failed. Check your credentials.');
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="bg-[#1a1d27] rounded-3xl p-8 shadow-2xl border border-white/5 backdrop-blur-xl relative">
                    ...
                    <div className="relative z-10 space-y-5">
                        ...
                        <button
                            ...
                            type="button"
                            className="w-full group py-3 px-4 rounded-xl bg-[#2d3142] hover:bg-[#3b4055] border border-white/5 transition-all flex items-center justify-center gap-3"
                        >
                        ...
                        <div className="flex items-center gap-3 opacity-50 py-1">
                            ...
                            <span className="text-xs font-medium text-white tracking-widest uppercase">OR</span>
